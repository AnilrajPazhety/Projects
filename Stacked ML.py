##Stacked Machine Learning is a .py notebook where t-SNE, Principal Components Analysis and Factor Analysis
## were applied to reduce dimensionality of data. Classification performances were measured after applying K-Means.
...
print('DIMENSIONS AFTER pca',np.array(X_pca).shape)
